...
function DogCards({ pet }) {
  ...
  const name = pet.name || "Unknown Breed";
  const description = pet.description || "No description";
  const temperament = pet.temperament || "No temperament";
  const min = 51;
  const max = 100;
  ...
  const lightboxContent = (
    <div>
      <h1 className="font-bold py-2 text-black">{name}</h1>
      <img
        src={imageUrl}
        alt={pet.name}
      ...
      <h4 className="font-bold py-1 text-black">Description:</h4>
      <h5 className="font-semibold py-1 text-black">{description}</h5>

      <h4 className="font-bold py-1 text-black"> Temperament:</h4>
      <h5 className="font-semibold py-1 text-black">{temperament}</h5>
    </div>
  );
    ...
    <div>
      ...
      >
        ...
        <div className="flex flex-col justify-between h-40 mt-2">
          <h1 className="text-black font-semibold text-lg mb-2">{name}</h1>
